...
exports.WardleyMapParser = void 0;
class WardleyMapParser {
    static parse(text) {
    ...
    static parseComponent(line) {
        ...
        else if (rest.includes('(buy)'))
            component.category = 'buy';
        else if (rest.includes('(outsource)'))
            component.category = 'outsource';
        if (rest.includes('inertia'))
...
exports.WardleyMapParser = WardleyMapParser;
